...
final class LastAndFirstMen3DRenderer: NSObject, MTKViewDelegate {
    ...
    private func buildScene() {
        ...
        for _ in 0..<30 {
            ...
            let th = Float(Double.random(in: 0...Double(2 * Float.pi), using: &rngP))
