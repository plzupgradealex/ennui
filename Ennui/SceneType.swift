...
enum SceneKind: String, CaseIterable, Identifiable {
    ...
    var tapHint: String {
        ...
        case .ontarioCountryside3D: return "Tap to burst a swarm of fireflies into the evening air"
        case .minnesotaSmallTown3D: return "Tap to burst a swarm of fireflies over Main Street"
