...
struct ContentView: View {
    ...
    private func sceneView(for scene: SceneKind) -> some View {
        ...
        case .artDecoLA3D: ArtDecoLAScene(interaction: interaction)
        case .urbanDreamscape3D: UrbanDreamscapeScene(interaction: interaction)
        case .shimizuEvening3D: ShimizuEveningScene(interaction: interaction)
        case .ontarioCountryside3D: OntarioCountrysideScene(interaction: interaction)
        case .minnesotaSmallTown3D: MinnesotaSmallTownScene(interaction: interaction)
        ...
        case .paperLanternFestival3D: PaperLanternFestivalScene(interaction: interaction)
